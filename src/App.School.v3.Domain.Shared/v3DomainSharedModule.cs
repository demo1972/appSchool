...
public class v3DomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<v3DomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/v3");

            options.DefaultResourceType = typeof(v3Resource);
        ...
        {
            options.MapCodeNamespace("v3", typeof(v3Resource));
        });
    }
}
