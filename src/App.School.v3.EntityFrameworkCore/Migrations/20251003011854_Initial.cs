    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolsDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SchoolsDatas_Cities_IdCity",
                        column: x => x.IdCity,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentsStuddents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentsStuddents_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentsStuddents_StudentId",
                table: "DocumentsStuddents",
                column: "StudentId");
